...
8. 在 `docs/release/roadmap.md` 中记录晋升。
...
尚未评估或仍有明确待完成工作的模块：`x/ai`（稳定层级子包单独评估）、`x/gateway/discovery`、`x/data`、`x/messaging/scheduler`、`x/messaging/webhook`、`x/messaging`、`x/messaging/mq`、`x/messaging/pubsub`。
