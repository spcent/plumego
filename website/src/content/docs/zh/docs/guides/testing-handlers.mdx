...
[`reference/standard-service/internal/handler/api.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/api.go) 展示了带注入依赖的 handler 结构体，其形状与本指南描述一致。
