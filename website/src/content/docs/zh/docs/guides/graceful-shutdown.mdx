...
[`reference/standard-service/main.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/main.go) 展示了完整的优雅关闭接线 — 信号上下文、`ListenAndServe` 错误通道和带超时的 `app.Shutdown`。

## 下一步阅读

- [core API 快速参考](/zh/docs/reference/api-core) — `App.Prepare`、`App.Server` 和 `App.Shutdown` 签名
