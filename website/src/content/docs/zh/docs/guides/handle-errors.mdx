...
参考服务的 handler 文件展示了 `WriteError` 和 `NewErrorBuilder` 在完整可运行 handler 中的用法：

- [`reference/standard-service/internal/handler/api.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/api.go)
- [`reference/standard-service/internal/handler/health.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/health.go)
