...
| Production upgrade risk is unclear | Check `x/rest/module.yaml`, [Release Posture](/docs/release-posture), and application tests that pin query semantics |
...
- [`reference/standard-service/internal/handler/api.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/api.go) — canonical handler shape with `WriteResponse` and `WriteError`
- [`reference/standard-service/internal/app/routes.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/app/routes.go) — route wiring that keeps controller instantiation explicit
...
- [contract API Reference](/docs/reference/api-contract)
