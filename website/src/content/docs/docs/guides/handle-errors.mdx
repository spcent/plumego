...
The reference service handler at [`reference/standard-service/internal/handler/api.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/api.go) shows `WriteError` and `NewErrorBuilder` in a complete, runnable handler. The health handler at [`reference/standard-service/internal/handler/health.go`](https://github.com/spcent/plumego/blob/main/reference/standard-service/internal/handler/health.go) shows the same pattern for liveness and readiness endpoints.
