...
| Input value is present but invalid (wrong format, out of range) | `contract.TypeInvalidInput` |
...
| Server-side failure that is not the client's fault | `contract.TypeInternalError` |
