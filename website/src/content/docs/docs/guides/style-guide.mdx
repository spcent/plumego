...
The inline `if err != nil` form is canonical for very small route tables. Once a
...
This is a sanctioned canonical pattern, not a forbidden registration idiom: it
