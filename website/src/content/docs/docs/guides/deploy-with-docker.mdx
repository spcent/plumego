...
- [`reference/standard-service/Dockerfile`](https://github.com/spcent/plumego/blob/main/reference/standard-service/Dockerfile) — multi-stage build, distroless final image, non-root user
- [`reference/standard-service/docker-compose.yml`](https://github.com/spcent/plumego/blob/main/reference/standard-service/docker-compose.yml) — local compose setup with environment variable injection
