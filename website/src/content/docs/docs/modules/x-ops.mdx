---
title: x/observability/ops Primer
...
| Keep it in `x/observability/ops` when the work is about | Move out when the work becomes |
| --- | --- |
...
- [x/observability/devtools Primer](/docs/modules/x-devtools)
