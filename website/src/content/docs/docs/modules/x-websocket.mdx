...
- you are managing a hub of concurrent WebSocket connections (`NewHub`, `NewHubWithConfigE`)
...
| `NewHub`, `NewHubWithConfigE`: connection pool management and lifecycle | generic publish-subscribe fan-out without WebSocket framing — use `x/pubsub` |
