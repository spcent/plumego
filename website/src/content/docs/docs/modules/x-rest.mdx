...
`x/rest` is an extension surface, not part of the smallest stable-root path.
Check `x/rest/module.yaml`, [Release Posture](/docs/release-posture), and
[Extension Maturity](/docs/concepts/extension-maturity) before using it in a
