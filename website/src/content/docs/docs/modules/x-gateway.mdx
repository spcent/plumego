...
Gateway and edge transport behavior should be isolated behind application-local
configuration when compatibility matters. Check `x/gateway/module.yaml`,
[Release Posture](/docs/release-posture), and
[Extension Maturity](/docs/concepts/extension-maturity) before adopting proxy,
...
### Reverse proxy with static backends
...
### Register a proxied route in one call
