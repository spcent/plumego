...
| --- | --- |
| `log.LevelDebug` | Verbose — for development |
| `log.LevelInfo` | Normal operational messages |
| `log.LevelWarn` | Non-fatal issues |
| `log.LevelError` | Errors requiring attention |
| `log.LevelFatal` | Calls `os.Exit(1)` after logging |
