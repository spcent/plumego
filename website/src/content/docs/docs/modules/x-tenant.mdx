...
Tenant isolation is security-sensitive, but that does not turn `x/tenant` into
a stable root. Check `x/tenant/module.yaml`, [Release Posture](/docs/release-posture),
and [Extension Maturity](/docs/concepts/extension-maturity) before adopting it.
