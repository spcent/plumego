...
> **Beta** (app-facing service layer) — API is stable within a minor version. Subordinate packages (`x/messaging/mq`, `x/messaging/pubsub`, `x/messaging/scheduler`, `x/messaging/webhook`) remain experimental. Check [Release Posture](/docs/release-posture) and [Extension Maturity](/docs/concepts/extension-maturity) before adopting in production.
