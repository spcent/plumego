...
- **Beta extensions** (`x/rest`, `x/websocket`, `x/gateway`, `x/observability`): safe to adopt in production. APIs are frozen between minor release refs; check release notes before upgrading.
