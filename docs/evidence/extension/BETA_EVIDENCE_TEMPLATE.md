...
See `docs/reference/extension-stability-policy.md` for promotion criteria and
...
- Baseline snapshot: `docs/evidence/extension/snapshots/<candidate>/base.snapshot`
- Candidate snapshot: `docs/evidence/extension/snapshots/<candidate>/head.snapshot`
...
go run ./internal/checks/extension-release-evidence \
  ...
  -out-dir docs/evidence/extension/snapshots/<candidate>
```
...
- module: x/<family>
  ...
  evidence_doc: docs/evidence/extension/x-<family>.md
  release_refs:
    - <older-ref>
    - <newer-ref>
  api_snapshots:
    - docs/evidence/extension/snapshots/<candidate>/base.snapshot
    - docs/evidence/extension/snapshots/<candidate>/head.snapshot
...
2. Check in generated snapshots under `docs/evidence/extension/snapshots/<candidate>/`.
...
7. Update `docs/concepts/extension-maturity.md` dashboard row status and evidence column.
