...
- `docs/evidence/extension/snapshots/ai-stable-tier/x-ai-tool-head.snapshot`
- `docs/evidence/extension/snapshots/x-ai-tool/base.snapshot`
- `docs/evidence/extension/snapshots/x-ai-tool/head.snapshot`

v1 baseline intake artifacts:

- `docs/evidence/extension/snapshots/v1-baseline/x-ai-tool/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-ai-tool/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-ai-tool/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-ai-tool/head.snapshot`
...
> in docs/reference/extension-stability-policy.md and accept the beta compatibility
