...
- `docs/evidence/extension/snapshots/x-frontend/base.snapshot`
- `docs/evidence/extension/snapshots/x-frontend/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-frontend/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-frontend/head.snapshot`
