...
- `docs/evidence/extension/snapshots/v1-baseline/x-messaging/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-messaging/head.snapshot`
- `docs/evidence/extension/snapshots/x-messaging/base.snapshot`
- `docs/evidence/extension/snapshots/x-messaging/head.snapshot`
