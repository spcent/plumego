...
- `docs/evidence/extension/snapshots/x-observability/base.snapshot`
- `docs/evidence/extension/snapshots/x-observability/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-observability/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-observability/head.snapshot`
