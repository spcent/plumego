...
- `docs/evidence/extension/snapshots/ai-stable-tier/x-ai-streaming-head.snapshot`
- `docs/evidence/extension/snapshots/x-ai-streaming/base.snapshot`
- `docs/evidence/extension/snapshots/x-ai-streaming/head.snapshot`

v1 baseline intake artifacts:

- `docs/evidence/extension/snapshots/v1-baseline/x-ai-streaming/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-ai-streaming/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-ai-streaming/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-ai-streaming/head.snapshot`
