...
- `docs/evidence/extension/snapshots/x-gateway/base.snapshot`
- `docs/evidence/extension/snapshots/x-gateway/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-gateway/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-gateway/head.snapshot`
