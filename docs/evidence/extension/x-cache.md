...
- `docs/evidence/extension/snapshots/x-cache/x-cache-distributed-head.snapshot`
- `docs/evidence/extension/snapshots/x-cache/x-cache-leaderboard-head.snapshot`
- `docs/evidence/extension/snapshots/x-cache/x-cache-redis-head.snapshot`
...
- Keep `x/data/cache/module.yaml` status as `experimental` until the promotion
  process in `docs/reference/extension-stability-policy.md` is complete.
...
- `env GOCACHE=/private/tmp/plumego-gocache go run ./internal/checks/extension-api-snapshot -module ./x/data/cache/distributed -out docs/evidence/extension/snapshots/x-cache/x-cache-distributed-head.snapshot`
- `env GOCACHE=/private/tmp/plumego-gocache go run ./internal/checks/extension-api-snapshot -module ./x/data/cache/leaderboard -out docs/evidence/extension/snapshots/x-cache/x-cache-leaderboard-head.snapshot`
- `env GOCACHE=/private/tmp/plumego-gocache go run ./internal/checks/extension-api-snapshot -module ./x/data/cache/redis -out docs/evidence/extension/snapshots/x-cache/x-cache-redis-head.snapshot`
