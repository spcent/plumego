...
- `docs/evidence/extension/snapshots/v1-baseline/x-data-file/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-data-file/head.snapshot`
- `docs/evidence/extension/snapshots/x-data-file/base.snapshot`
- `docs/evidence/extension/snapshots/x-data-file/head.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-data-idempotency/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-data-idempotency/head.snapshot`
- `docs/evidence/extension/snapshots/x-data-idempotency/base.snapshot`
- `docs/evidence/extension/snapshots/x-data-idempotency/head.snapshot`
...
> meet the beta criteria in docs/reference/extension-stability-policy.md and accept the
