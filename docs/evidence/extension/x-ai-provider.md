...
- `docs/evidence/extension/snapshots/ai-stable-tier/x-ai-provider-head.snapshot`
- `docs/evidence/extension/snapshots/x-ai-provider/base.snapshot`
- `docs/evidence/extension/snapshots/x-ai-provider/head.snapshot`

v1 baseline intake artifacts:

- `docs/evidence/extension/snapshots/v1-baseline/x-ai-provider/base.snapshot`
- `docs/evidence/extension/snapshots/v1-baseline/x-ai-provider/head.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-ai-provider/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-ai-provider/head.snapshot`
