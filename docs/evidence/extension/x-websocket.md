...
- `docs/evidence/extension/snapshots/x-websocket/base.snapshot`
- `docs/evidence/extension/snapshots/x-websocket/head.snapshot`

Required release snapshot refs:

- `docs/evidence/extension/snapshots/<older_minor_release_ref>/x-websocket.snapshot`
- `docs/evidence/extension/snapshots/<newer_minor_release_ref>/x-websocket.snapshot`
...
- Base: `docs/evidence/extension/snapshots/x-websocket/base.snapshot`
- Head: `docs/evidence/extension/snapshots/x-websocket/head.snapshot`
