...
For the broader adoption sequence, read `docs/start/adoption-path.md`.
...
[`docs/start/troubleshooting.md`](./troubleshooting.md). Common issues include:
