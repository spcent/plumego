...
- `docs/extension-evidence/snapshots/x-ai-session/base.snapshot`
- `docs/extension-evidence/snapshots/x-ai-session/head.snapshot`
...
- Base: `docs/extension-evidence/snapshots/x-ai-session/base.snapshot`
- Head: `docs/extension-evidence/snapshots/x-ai-session/head.snapshot`
