...
| PR | Reviewer-facing package | PR Packager | `docs/assets/github-workflows/milestone-pr-template.md` |
...
Use [`docs/assets/github-workflows/milestone-pr-template.md`](../assets/github-workflows/milestone-pr-template.md).
...
For the actual template files with comments and examples, see:
- [`tasks/milestones/TEMPLATE.md`](../../tasks/milestones/TEMPLATE.md)
- [`tasks/milestones/PLAN_TEMPLATE.md`](../../tasks/milestones/PLAN_TEMPLATE.md)
- [`tasks/milestones/VERIFY_TEMPLATE.md`](../../tasks/milestones/VERIFY_TEMPLATE.md)
- [`tasks/cards/TEMPLATE.md`](../../tasks/cards/TEMPLATE.md)
- [`docs/assets/github-workflows/milestone-pr-template.md`](../assets/github-workflows/milestone-pr-template.md)
