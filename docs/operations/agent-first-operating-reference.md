...
see `docs/concepts/agent-first.md`.
...
For repeatable execution patterns, see `docs/operations/codex-workflow.md`.
For quality preflight rules, see `docs/operations/agent-code-quality-rules.md`.
...
- `docs/evidence/stable-api/snapshots/` — generated outputs, not hand-edited
...
2. Select context package → docs/operations/agent-context-budget.md if unclear
