...
- return stable validation errors for malformed query parameters (`page`, `page_size`, time filters, `expiry`) and avoid exposing backend error text in client responses
