...
> **Package**: `github.com/spcent/plumego/x/ai/semanticcache` | **Feature**: Embedding-based caching
...
```go
import "github.com/spcent/plumego/x/ai/semanticcache"
...
```go
import "github.com/spcent/plumego/x/ai/semanticcache/embedding"
...
```go
import "github.com/spcent/plumego/x/ai/llmcache"
