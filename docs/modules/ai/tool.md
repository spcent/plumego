...
> **Package**: `github.com/spcent/plumego/ai/tool` | **Feature**: Agent capabilities
...
```go
import "github.com/spcent/plumego/ai/tool"
...
```go
import "github.com/spcent/plumego/ai/tool/builtin"
