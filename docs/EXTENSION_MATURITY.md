...
| `x/frontend` | experimental | medium | frontend | Explicit static or embedded asset serving | docs:primer; coverage:asset-serving | `go test -timeout 20s ./x/frontend/...` | Hardened asset-serving coverage; needs API snapshot, release history, and owner sign-off before promotion |
