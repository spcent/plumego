...
This is the external overview of Plumego's agent-first repository model. It is
...
docs such as `docs/operations/codex-workflow.md`, `docs/operations/agent-context-budget.md`,
`docs/operations/agent-code-quality-rules.md`, and `docs/reference/canonical-style-guide.md` keep
