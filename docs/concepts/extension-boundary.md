...
For the promotion criteria in detail, see `docs/reference/extension-stability-policy.md`.
For the current maturity status of each family, see `docs/concepts/extension-maturity.md`.
...
1. Check `docs/concepts/extension-maturity.md` for current status and recommended
   entrypoint.
...
`docs/evidence/extension/<family>.md` using the template in
`docs/evidence/extension/BETA_EVIDENCE_TEMPLATE.md`.
