...
appropriate `x/*` family. See `docs/architecture/core-boundary.md`.
...
- Style and wiring conventions: `docs/CANONICAL_STYLE_GUIDE.md`
- When Plumego is not the right fit: `docs/when-not-to-use-plumego.md`
