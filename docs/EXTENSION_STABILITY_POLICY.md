...
|---|---|---|
| experimental | beta | Two consecutive release refs with no exported API changes; owner sign-off; beta evidence recorded in `docs/extension-evidence/`. |
| beta | ga | Two production release cycles; full coverage at stable tier; boundary review sign-off; entry in `docs/stable-api/`. |
