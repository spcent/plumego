...
func (a *App) RegisterRoutes() error {
	...
	//                      PUT   /api/v1/items/:id {"name":"…","description":"…"}                 → 200 item or 404 (guarded, replaces all fields)
	//                      PATCH /api/v1/items/:id {"name":"…"}                                   → 200 item or 404 (guarded, updates only non-empty fields)
