...
func Catalog() []MetricSpec {
	return []MetricSpec{
		...
		{Name: MetricWorkerActiveCases, Kind: MetricKindGauge, Stability: MetricStabilityExperimental, Description: "Current active cases by namespace, node, and pod.", Labels: []string{LabelNamespace, LabelNode, LabelPod}},
		...
		{Name: MetricWorkerHeartbeatAgeSeconds, Kind: MetricKindGauge, Stability: MetricStabilityExperimental, Description: "Worker heartbeat age in seconds by namespace, node, pod, and worker status.", Labels: []string{LabelNamespace, LabelNode, LabelPod, LabelStatus}},
