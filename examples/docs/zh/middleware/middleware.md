...
- HTTP 指标：`observability.HTTPMetrics(metricsCollector)`
- 访问日志：`observability.AccessLog(app.Logger())`
- 组合便捷入口：`observability.Logging(app.Logger(), metricsCollector, tracer)`
