...
- Decision: NO-GO on May 15, 2026.
- Rationale: `v1.0.0-rc.1` gates are green, but the rc observation window has
  not completed.
- Follow-up: card 1436 owns observation-window closure and final v1 handoff.

## Open Issues

- Observation-window closure is scheduled in card 1436.

## Final Verdict

- `NO-GO`
- rationale: rc evidence is healthy, but final `v1.0.0` must wait for the
