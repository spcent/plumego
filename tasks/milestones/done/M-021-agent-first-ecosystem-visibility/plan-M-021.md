...
2. Implement: add `docs/concepts/agent-first.md`, update `quality-gates.yml`, and add README links.
...
- README links depend on `docs/concepts/agent-first.md` existing.
...
- Overlong or under-specified guide. Mitigation: keep `docs/concepts/agent-first.md` between 600 and 900 words and link concrete repo files.
