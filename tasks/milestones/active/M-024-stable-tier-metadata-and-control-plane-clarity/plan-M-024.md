...
| 2064 | Replace the case-only `docs/AGENT_FIRST.md` vs `docs/agent-first.md` split with clearly distinguished internal vs external document naming and references. | `docs` | `AGENTS.md`, `docs/README.md`, `docs/AGENT_FIRST.md`, `docs/agent-first-operating-reference.md`, `README.md` | M-022 | `agent-workflow`, `gofmt -l .` |
...
- Verified and queued: `docs/AGENT_FIRST.md` and the detailed internal agent-first guide are now distinguished in `docs/README.md`, but the case-only filename split remained an avoidable source of confusion before this card.
