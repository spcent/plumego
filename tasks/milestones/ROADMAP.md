...
| M-025 | Mini SaaS API Use-Case | [ ] | — | Proposal authored; new `use-cases/mini-saas-api` demonstrating stable roots + x/rest, x/tenant, x/observability; implementation not started |
