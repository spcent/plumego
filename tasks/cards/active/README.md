...
|---|---|---|---|
| [0742](0742-x-websocket-runtime-edge-contracts.md) | P0 | x/websocket | Fix runtime edge-case contracts |
| [0743](0743-x-websocket-handshake-auth-metrics.md) | P0 | x/websocket | Align auth ordering and rejection metrics |
