...
| [0749](0749-x-frontend-public-api-freeze-ledger.md) | P1 | x/frontend | Freeze public API ledger and sealed option contract |
| [0750](0750-x-frontend-release-gate-blocker-ledger.md) | P2 | x/frontend | Record verified stable blockers and release gate expectations |
