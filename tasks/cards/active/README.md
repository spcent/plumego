...
| [1394](1394-x-gateway-transform-safe-write-convergence.md) | P1 | x/gateway/transform | Remove duplicate safe-write helper while preserving transform response buffering |
| [1395](1395-x-gateway-transform-buffered-response-helper.md) | P1 | internal/httputil | Extract the non-forwarding buffered response helper used by gateway transforms |
