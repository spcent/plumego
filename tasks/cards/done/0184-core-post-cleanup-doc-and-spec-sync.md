...
- `CLAUDE.md`
Depends On:
- `0180-core-runtime-state-contract-collapse.md`
- `0181-core-server-settings-projection-deduplication.md`
- `0182-core-logger-lifecycle-ownership-removal.md`
- `0183-core-introspection-surface-pruning.md`
