...
State: done
Primary Module: core
Owned Files: tasks/cards/done/0721-stable-root-api-inventory.md, core/module.yaml, router/module.yaml, contract/module.yaml, middleware/module.yaml
Depends On: M-001
...
tasks/cards/done/0721-stable-root-api-inventory.md
