...
go test ./x/ai/semanticcache/embedding -v

# Test vector stores
go test ./x/ai/semanticcache/vectorstore -v

# Benchmarks
go test ./x/ai/semanticcache/embedding -bench=. -benchmem
go test ./x/ai/semanticcache/vectorstore -bench=. -benchmem
```
