-- V0.1 initial schema for Markdown Cloud Vault
...
-- Tags (reserved for V0.2 — table is created now for schema stability)
...
-- Sync jobs (reserved for V0.2 background retry logic)
