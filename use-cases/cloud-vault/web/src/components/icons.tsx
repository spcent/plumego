...
const paths: Record<IconName, ReactNode> = {
  ...
  bold: <><path d="M8 5h5a3 3 0 0 1 0 6H8Z" /><path d="M8 11h6a3.2 3.2 0 0 1 0 6.4H8Z" /><path d="M8 5v12.4" /></>,
  ...
  checkbox: <><rect x="4" y="5" width="14" height="14" rx="2" /><path d="m8 12 3 3 6-7" /></>,
  ...
  image: <><rect x="4" y="5" width="16" height="14" rx="2" /><circle cx="9" cy="10" r="1.4" /><path d="m7 17 4.2-4.2a1.4 1.4 0 0 1 2 0L18 17" /></>,
  ...
  link: <><path d="M10.5 13.5a4 4 0 0 0 5.7 0l2-2a4 4 0 0 0-5.7-5.7l-1.1 1.1" /><path d="M13.5 10.5a4 4 0 0 0-5.7 0l-2 2a4 4 0 0 0 5.7 5.7l1.1-1.1" /></>,
  list: <><path d="M9 7h11" /><path d="M9 12h11" /><path d="M9 17h11" /><path d="M4.5 7h.1" /><path d="M4.5 12h.1" /><path d="M4.5 17h.1" /></>,
  listOrdered: <><path d="M10 7h10" /><path d="M10 12h10" /><path d="M10 17h10" /><path d="M4 6.5 5.2 5v4" /><path d="M4 11h2v1l-2 2h2" /><path d="M4 16h2l-1.2 1.2A1.1 1.1 0 0 1 6 18.3C6 19 5.5 19.5 4.8 19.5H4" /></>,
  ...
  quote: <><path d="M8 9h4v7H6v-5a6 6 0 0 1 6-6" /><path d="M17 9h4v7h-6v-5a6 6 0 0 1 6-6" /></>,
  refresh: <><path d="M20 12a8 8 0 0 1-13.7 5.6" /><path d="M4 12A8 8 0 0 1 17.7 6.4" /><path d="M17.5 3.5v3h-3" /><path d="M6.5 20.5v-3h3" /></>,
  redo: <><path d="M20 7v5h-5" /><path d="M20 12a7 7 0 0 0-12.1-4.8L4 11" /></>,
  ...
  share: <><path d="M8 12h8" /><path d="M13 7l5 5-5 5" /><path d="M4 5v14" /></>,
  ...
  table: <><rect x="4" y="5" width="16" height="14" rx="1.5" /><path d="M4 10h16" /><path d="M4 15h16" /><path d="M10 5v14" /><path d="M16 5v14" /></>,
  trash: <><path d="M5 7h14" /><path d="M9 7V5h6v2" /><path d="M7 7l1 13h8l1-13" /><path d="M10 11v5" /><path d="M14 11v5" /></>,
  undo: <><path d="M4 7v5h5" /><path d="M4 12a7 7 0 0 1 12.1-4.8L20 11" /></>,
