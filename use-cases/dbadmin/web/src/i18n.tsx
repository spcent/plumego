...
const en: Dict = {
  ...
  'data.drawer.changed_summary': '{changed} changed / {total} fields',
  'data.drawer.included_summary': '{included} included / {total} fields',
  'data.drawer.include': 'include',
  'data.drawer.original': 'was: {value}',
  'data.drawer.pending_changes': '{n} pending change(s)',
  'data.drawer.no_field_changes': 'No field changes',
  'data.drawer.fields_will_send': '{n} field(s) will be sent',
  ...
  'redis.export': 'Export JSON',
  'redis.import': 'Import JSON',
  'redis.importing': 'Importing…',
  'redis.import_hint': 'Paste a JSON snapshot exported from this Redis browser.',
  'redis.import.invalid': 'Invalid Redis export JSON',
  'redis.import.success': 'Imported {count} key(s)',
  'redis.import.partial_error': '{count} key(s) failed to import',
  'redis.import.error': 'Import failed',
  ...
  'mongodb.p1.import.partial_error': '{count} document(s) failed to import',
  ...
  'elasticsearch.tab.overview': 'Overview',
  'elasticsearch.tab.mapping': 'Mapping',
  'elasticsearch.tab.settings': 'Settings',
  'elasticsearch.tab.search': 'Search',
  'elasticsearch.tab.documents': 'Documents',
  'elasticsearch.cluster_info': 'Cluster Info',
  'elasticsearch.cluster_name': 'Cluster Name',
  'elasticsearch.version': 'Version',
  'elasticsearch.lucene_version': 'Lucene Version',
  'elasticsearch.indices': 'Indices',
  'elasticsearch.index_name': 'Index',
  'elasticsearch.health': 'Health',
  'elasticsearch.status': 'Status',
  'elasticsearch.docs_count': 'Documents',
  'elasticsearch.store_size': 'Store Size',
  'elasticsearch.mapping_title': 'Index Mapping',
  'elasticsearch.settings_title': 'Index Settings',
  'elasticsearch.copy': 'Copy',
  'elasticsearch.copied': 'Copied!',
  'elasticsearch.search_placeholder': '{"query":{"match_all":{}},"size":50}',
  'elasticsearch.execute': 'Execute',
  'elasticsearch.executing': 'Executing...',
  'elasticsearch.took': 'Took {ms}ms',
  'elasticsearch.total_hits': '{count} hits',
  'elasticsearch.timed_out': 'TIMED OUT',
  'elasticsearch.hits': 'Hits',
  'elasticsearch.raw_json': 'Raw JSON',
  'elasticsearch.doc_id': 'Document ID',
  'elasticsearch.score': 'Score',
  'elasticsearch.no_results': 'No results',
  'elasticsearch.search_error': 'Search Error',
  'elasticsearch.invalid_json': 'Invalid JSON in DSL',
  'elasticsearch.history': 'Query History',
  'elasticsearch.history_empty': 'No search history',
  ...
  'elasticsearch.import_partial_error': '{count} document(s) failed to import',
  ...
  'elasticsearch.delete_document_confirm': 'Delete document "{id}" from index "{index}"? This cannot be undone.',
  'elasticsearch.delete_document_success': 'Document deleted',
  'elasticsearch.confirm': 'Confirm',
  'elasticsearch.cancel': 'Cancel',
  'elasticsearch.no_indices': 'No indices found',
  'elasticsearch.load_error': 'Failed to load',
  ...
  // Dangerous operation labels
  'danger.delete_document': 'Delete Document',
  'danger.drop_collection': 'Drop Collection',
  'danger.drop_table': 'Drop Table',
  'danger.truncate_table': 'Truncate Table',
  'danger.flush_database': 'Flush Database',
  'danger.delete_key': 'Delete Key',
  'danger.batch_delete': 'Batch Delete',
  ...
  'history.redis': 'Redis Command History',
  'history.enable': 'Enable History',
  'history.disable': 'Disable History',
  'history.clear_confirm': 'Clear all history for this connection?',
  'history.delete_entry': 'Delete this entry',
  ...
  'resource.open': 'Open',
  'resource.copy_path': 'Copy Path',
  'resource.copy_name': 'Copy Name',
  'resource.copy_success': 'Copied',
...
const zh: Dict = {
  ...
  'data.drawer.changed_summary': '已修改 {changed} / {total} 个字段',
  'data.drawer.included_summary': '将提交 {included} / {total} 个字段',
  'data.drawer.include': '包含',
  'data.drawer.original': '原值：{value}',
  'data.drawer.pending_changes': '{n} 处待保存修改',
  'data.drawer.no_field_changes': '字段未修改',
  'data.drawer.fields_will_send': '将提交 {n} 个字段',
  ...
  'redis.export': '导出 JSON',
  'redis.import': '导入 JSON',
  'redis.importing': '导入中…',
  'redis.import_hint': '粘贴从 Redis 浏览器导出的 JSON 快照。',
  'redis.import.invalid': 'Redis 导出 JSON 无效',
  'redis.import.success': '已导入 {count} 个 Key',
  'redis.import.partial_error': '{count} 个 Key 导入失败',
  'redis.import.error': '导入失败',
  ...
  'mongodb.p1.import.partial_error': '{count} 个文档导入失败',
  ...
  'elasticsearch.tab.overview': '概览',
  'elasticsearch.tab.mapping': 'Mapping',
  'elasticsearch.tab.settings': '设置',
  'elasticsearch.tab.search': '搜索',
  'elasticsearch.tab.documents': '文档',
  'elasticsearch.cluster_info': '集群信息',
  'elasticsearch.cluster_name': '集群名称',
  'elasticsearch.version': '版本',
  'elasticsearch.lucene_version': 'Lucene 版本',
  'elasticsearch.indices': '索引列表',
  'elasticsearch.index_name': '索引',
  'elasticsearch.health': '健康状态',
  'elasticsearch.status': '状态',
  'elasticsearch.docs_count': '文档数',
  'elasticsearch.store_size': '存储大小',
  'elasticsearch.mapping_title': '索引 Mapping',
  'elasticsearch.settings_title': '索引设置',
  'elasticsearch.copy': '复制',
  'elasticsearch.copied': '已复制！',
  'elasticsearch.search_placeholder': '{"query":{"match_all":{}},"size":50}',
  'elasticsearch.execute': '执行',
  'elasticsearch.executing': '执行中...',
  'elasticsearch.took': '耗时 {ms}ms',
  'elasticsearch.total_hits': '{count} 条结果',
  'elasticsearch.timed_out': '超时',
  'elasticsearch.hits': '命中',
  'elasticsearch.raw_json': '原始 JSON',
  'elasticsearch.doc_id': '文档 ID',
  'elasticsearch.score': '评分',
  'elasticsearch.no_results': '无结果',
  'elasticsearch.search_error': '搜索错误',
  'elasticsearch.invalid_json': 'DSL 中的 JSON 无效',
  'elasticsearch.history': '查询历史',
  'elasticsearch.history_empty': '暂无搜索历史',
  ...
  'elasticsearch.import_partial_error': '{count} 个文档导入失败',
  ...
  'elasticsearch.delete_document_confirm': '从索引 "{index}" 中删除文档 "{id}"？此操作不可撤销。',
  'elasticsearch.delete_document_success': '文档已删除',
  'elasticsearch.confirm': '确认',
  'elasticsearch.cancel': '取消',
  'elasticsearch.no_indices': '未找到索引',
  'elasticsearch.load_error': '加载失败',

  // WorkbenchHeader
  'workbench.refresh': '刷新',
  'workbench.readonly': '只读',
  'workbench.connection': '连接',
  ...
  // Dangerous operation labels
  'danger.delete_document': '删除文档',
  'danger.drop_collection': '删除集合',
  'danger.drop_table': '删除表',
  'danger.truncate_table': '清空表',
  'danger.flush_database': '清空数据库',
  'danger.delete_key': '删除 Key',
  'danger.batch_delete': '批量删除',
  ...
  'history.redis': 'Redis 命令历史',
  'history.enable': '启用历史',
  'history.disable': '关闭历史',
  'history.clear_confirm': '清除此连接的所有历史？',
  'history.delete_entry': '删除此条目',
  ...
  'resource.view_data': '查看数据',
  'resource.view_structure': '查看结构',
  'resource.open': '打开',
  'resource.copy_path': '复制路径',
  'resource.copy_name': '复制名称',
  'resource.copy_success': '已复制',
